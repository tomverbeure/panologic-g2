...
class ChrontelPads(includeXClkN: Boolean = true) extends Component {
    ...
    u_pad_xclk_p.io.C0     <> clk
    u_pad_xclk_p.io.C1     <> !clk
    ...
    if (includeXClkN) new Area {
        ...
        u_pad_xclk_n.io.C0     <> clk
        u_pad_xclk_n.io.C1     <> !clk
    ...
    u_pad_vsync.io.C0      <> clk
    u_pad_vsync.io.C1      <> !clk
    ...
    u_pad_hsync.io.C0      <> clk
    u_pad_hsync.io.C1      <> !clk
